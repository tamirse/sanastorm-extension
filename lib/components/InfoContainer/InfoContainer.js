...
var InfoContainer = function (_Component) {
  ...
  _createClass(InfoContainer, [{
    ...
    value: function render() {
      ...
      var inflectionsListExpanded = this.isVerb() ? inflections.EXPANDED_KEYS.verbs : inflections.EXPANDED_KEYS.nouns;

      var inflectionsListMinimal = this.isVerb() ? inflections.MINIMAL_KEYS.verbs : inflections.MINIMAL_KEYS.nouns;
      ...
      var inflectionsArea = React.createElement(
        ...
        inflectionsListExpanded.map(function (inflection) {
          ...
          if (_this2.state.expandedInflections || inflectionsListMinimal.includes(inflection)) {
