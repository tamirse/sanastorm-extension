 ...
 */
var getSelectedElement = function getSelectedElement() {
 ...
 */
var getSelectionPosition = function getSelectionPosition(selectedElement) {
  var range = selectedElement.getRangeAt(0);
 ...
 */
var isTargetSanastormButton = function isTargetSanastormButton(event) {
...
export default {
  ...
  isTargetSanastormButton: isTargetSanastormButton,
