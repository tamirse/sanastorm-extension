...
export var INFINITIVE_2 = "inf2";
export var INFINITIVE_3 = "inf3";
export var INFINITIVE_4 = "inf4";
export var INFINITIVE_5 = "inf5";
...
export var MINIMAL_KEYS = {
  nouns: [NOMINATIVE, GENITIVE, PARTITIVE, ILLATIVE],
  verbs: [INFINITIVE, IMPERATIVE, PASSIVE]
};

export var EXPANDED_KEYS = {
  nouns: [NOMINATIVE, GENITIVE, PARTITIVE, INESSIVE, ELATIVE, ILLATIVE, ADESSIVE, ABLATIVE, ALLATIVE, ESSIVE, TRANSLATIVE, ABESSIVE, COMITATIVE],
