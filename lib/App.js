...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function getWordData() {
      ...
      var baseURL = "http://ec2-3-122-227-94.eu-central-1.compute.amazonaws.com:3000/api/sana/";
      ...
      return new Promise(function (resolve, reject) {
        _this5.fetchResource(baseURL + word).then(function (res) {
          ...
          if (!res) {
            ...
            if (word !== _this5.state.selectedText) {
              // if there was a suffix, try fetching again with modified word
              return _this5.fetchResource(baseURL + word);
            }
          } else {
            return res;
          }
